...
//             String businessPartnerId = (String) getParameters().get("businessPartnerId");
...
//                 orderCriteria.add(Restrictions.eq(Order.PROPERTY_BUSINESSPARTNER, OBDal.getInstance().get(BusinessPartner.class, businessPartnerId)));
//             } 
